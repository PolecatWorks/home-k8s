...
| [007-agent-as-data-workload-prd.md](./007-agent-as-data-workload-prd.md) | Agent-As-Data (AAD) Workload & Local Ingress Integration | Remote GitOps deployment, PostgreSQL + pgvector persistence, ESO PushSecret distribution, and local-only Istio ingress for Agent-As-Data. |
